...
from chess_vision.vision_visualizer import plot_board_grid, plot_piece_detections
...
def run() -> int:
    ...
    if args.plot:
        plot_board_grid(frame, corners, grid)
    ...
    if args.plot:
        plot_piece_detections(frame, raw_detections)
